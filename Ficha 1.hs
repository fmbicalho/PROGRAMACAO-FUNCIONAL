...
-- c) mostra uma dupla com o primeiro e ultimo de uma lista
primUlt :: [a] -> (a, a)
primUlt l = (head l, last l)


-- d) testa se o numero e multiplo ou nao
multiplo :: Int -> Int -> Bool
multiplo x y = mod x y == 0


-- e) se lista for impar retira o primeiro
truncaImpar l = if length l `mod` 2 == 0 then l else tail l


-- f) calcula o maior de 2 numeros inteiros
